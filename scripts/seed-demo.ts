...
const feedbackTemplates = [
  {
    ratings: {
      workQuality: { score: 4.5 },
      communication: { score: 4.0 },
      teamBehavior: { score: 5.0 },
      accountability: { score: 4.5 },
      overall: { score: 4.5, comment: 'A valuable team member who consistently delivers high-quality work.' },
    },
  ...
  {
    ratings: {
      workQuality: { score: 3.5 },
      communication: { score: 5.0 },
      teamBehavior: { score: 4.5 },
      accountability: { score: 4.0 },
      overall: { score: 4.5, comment: 'Excellent communicator who bridges the gap between technical and non-technical teams.' },
    },
  ...
  {
    ratings: {
      workQuality: { score: 4.0 },
      communication: { score: 3.5 },
      teamBehavior: { score: 4.0 },
      accountability: { score: 5.0 },
      overall: { score: 4.0, comment: 'Strong analytical thinker who adds significant value to the team.' },
    },
  ...
  {
    ratings: {
      workQuality: { score: 2.5 },
      communication: { score: 3.0 },
      teamBehavior: { score: 3.5 },
      accountability: { score: 2.5 },
      overall: { score: 3.0, comment: 'Has potential but needs more experience and mentorship.' },
    },
  ...
  {
    ratings: {
      workQuality: { score: 5.0 },
      communication: { score: 4.5 },
      teamBehavior: { score: 5.0 },
      accountability: { score: 5.0 },
      overall: { score: 5.0, comment: 'Top performer who sets the standard for the entire team.' },
    },
      ...
      for (let i = 0; i < numFeedback; i++) {
        ...
        if (i === 0) {
          ...
          await Feedback.create({
            ...
            reviewerFingerprint: `demo-${targetUser._id}-${i}`,
            reviewerIpHash: `hash-${targetUser._id}-${i}`,
            moderation: {
              status: 'approved',
            },
          });
